...
<p align="center">
  ...
  &nbsp;&nbsp;
  <img src="https://counter.othmaro.dev/api/views?id=othmarodev&label=Profile%20views&rightColor=blueviolet" alt="Profile views" />
</p>
...
*Built just in 30+ days · **240+ hours** · 33,104 lines of Swift across 95 files · **0 external dependencies**.*
...
| 🔐 **[Filaxy Vault](https://github.com/othmarodev/filaxy-vault)** | Local-first, zero-cloud password manager for macOS — encrypted vault never leaves your device, Argon2id + XChaCha20-Poly1305 *(WIP)* | Rust · Tauri · TypeScript · Vite · Tailwind |
...
![Lemon Squeezy](https://img.shields.io/badge/Lemon%20Squeezy-FFC233?style=flat-square&logo=lemonsqueezy&logoColor=black)

### ✨ What I'm into

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&duration=2800&pause=600&color=FF006E&center=true&vCenter=true&width=640&lines=Crafting+native+macOS+apps+with+Swift+%2B+SwiftUI;Building+cinematic+3D+web+with+Three.js+%2B+R3F;Designing+trading+platforms%2C+bots%2C+and+automation;Open-sourcing+tools+for+traders+and+builders;Shipping+from+Costa+Rica+%F0%9F%87%A8%F0%9F%87%B7+to+the+world" alt="Typing animation" />
</p>
...
<p align="center">
  <em>📩 For freelance inquiries: <a href="mailto:othmaro@othmaro.dev">othmaro@othmaro.dev</a></em><br/>
  <sub>Made with code, curiosity, and ☕ — from San José, Costa Rica.</sub>
</p>
